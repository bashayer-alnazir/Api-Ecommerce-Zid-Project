...
<div class="form-group col-sm-6">
    <div class="form-check">
        {!! Form::hidden('IsMerchants', 0, ['class' => 'form-check-input']) !!}
        {!! Form::checkbox('IsMerchants', '1', null, ['class' => 'form-check-input']) !!}
        {!! Form::label('IsMerchants', 'Ismerchants', ['class' => 'form-check-label']) !!}
    </div>
</div>
